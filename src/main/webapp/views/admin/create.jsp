        ...
        <main class="dashboard-main">
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Nhập đầy đủ thông tin bên dưới</p>
                </div>
                <div>
            ...
            <div class="section-card mt-3">
                ...
                <div class="p-3">
                    <!-- Giữ nguyên action & name field -->
                    <form action="${pageContext.request.contextPath}/admin/users/create" method="post" class="row g-3">
                        <div class="col-md-6">
